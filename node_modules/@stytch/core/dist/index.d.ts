...
interface IHeadlessB2BImpersonationClient<TProjectConfiguration extends StytchProjectConfigurationInput = Stytch.DefaultProjectConfiguration> {
    /**
     * The authenticate method wraps the {@link https://stytch.com/docs/b2b/api/impersonation authenticate} Impersonation API endpoint.
     *
...
declare class SessionManager<TProjectConfiguration extends StytchProjectConfigurationInput> implements ISessionManager {
    ...
    private timeout;
    constructor(_subscriptionService: IConsumerSubscriptionService<TProjectConfiguration> | IB2BSubscriptionService<TProjectConfiguration>, _headlessSessionClient: IHeadlessSessionClient<TProjectConfiguration> | IHeadlessB2BSessionClient<TProjectConfiguration>);
    /**
