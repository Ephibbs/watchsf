...
import { S as StytchAPIUnreachableError, a as StytchAPISchemaError, b as StytchAPIError, O as OTPMethods, c as StytchSDKUsageError, d as StytchSDKAPIError, e as StytchSDKSchemaError, f as SDKAPIUnreachableError, U as UNRECOVERABLE_ERROR_TYPES, g as OAuthProviders, B as B2BOAuthProviders } from './ui-916ca689.js';
      ...
      return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee39() {
        ...
        return _regeneratorRuntime().wrap(function _callee39$(_context39) {
          while (1) switch (_context39.prev = _context39.next) {
            ...
            case 2:
              _yield$this$_dynamicC = _context39.sent;
          ...
          return _regeneratorRuntime().wrap(function _callee40$(_context40) {
            while (1) switch (_context40.prev = _context40.next) {
              case 0:
                ...
                return this._dynamicConfig;
              case 2:
                _yield$this$_dynamicC2 = _context40.sent;
        ...
        return _regeneratorRuntime().wrap(function _callee41$(_context41) {
          while (1) switch (_context41.prev = _context41.next) {
            ...
            case 5:
              ...
              return this._config;
            case 8:
              _yield$this$_config3 = _context41.sent;
        ...
        return _regeneratorRuntime().wrap(function _callee53$(_context53) {
          while (1) switch (_context53.prev = _context53.next) {
            case 0:
              ...
              return this._config;
            case 2:
              _yield$this$_config4 = _context53.sent;
...
var HeadlessB2BOrganizationClient = /*#__PURE__*/_createClass(function HeadlessB2BOrganizationClient(_networkClient, _apiNetworkClient, _subscriptionService) {
  ...
  this._subscriptionService = _subscriptionService;
  this.get = function () {
    return __awaiter(_this13, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee96() {
      var resp;
...
var HeadlessB2BOAuthClient = /*#__PURE__*/function () {
  function HeadlessB2BOAuthClient(_networkClient, _subscriptionService, _pkceManager, _dynamicConfig, _config, dfpProtectedAuth) {
    ...
    this.discovery = {
      authenticate: function authenticate(data) {
        return __awaiter(_this14, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee109() {
  ...
  _createClass(HeadlessB2BOAuthClient, [{
    ...
    value: function startOAuthFlow(providerType) {
      ...
      return function (_ref8) {
        ...
        return __awaiter(_this15, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee112() {
...
var HeadlessB2BDiscoveryClient = /*#__PURE__*/_createClass(function HeadlessB2BDiscoveryClient(_networkClient, _subscriptionService) {
  ...
  this.organizations = {
    list: function list() {
      return __awaiter(_this19, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee118() {
  ...
  function HeadlessB2BPasswordsClient(_networkClient, _subscriptionService, _pkceManager) {
    ...
    this.discovery = {
      resetByEmailStart: function resetByEmailStart(options) {
        return __awaiter(_this20, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee121() {
      ...
      resetByEmail: function resetByEmail(options) {
        return __awaiter(_this20, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee122() {
...
var HeadlessB2BImpersonationClient = /*#__PURE__*/_createClass(function HeadlessB2BImpersonationClient(_networkClient, _subscriptionService, dfpProtectedAuth) {
  ...
  this.dfpProtectedAuth = dfpProtectedAuth;
  this.authenticate = function (data) {
    return __awaiter(_this24, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee142() {
        ...
        return _regeneratorRuntime().wrap(function _callee144$(_context144) {
          while (1) switch (_context144.prev = _context144.next) {
            ...
            case 12:
              ...
              port.postMessage({
                success: false,
                error: ErrorMarshaller.marshall(_context144.t0)
              });
            case 15:
            case "end":
              return _context144.stop();
          }
        }, _callee144, this, [[5, 12]]);
      }));
    }
...
var SessionManager = /*#__PURE__*/function () {
  function SessionManager(_subscriptionService, _headlessSessionClient) {
    ...
    this._reauthenticateWithBackoff = function () {
      return __awaiter(_this28, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee145() {
        var count;
...
var SubscriptionDataLayer = /*#__PURE__*/function () {
  function SubscriptionDataLayer(_publicToken, _storageClient) {
    ...
    this.syncFromLocalStorage = function () {
      return __awaiter(_this32, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee146() {
        var _this33 = this;
        return _regeneratorRuntime().wrap(function _callee146$(_context146) {
          while (1) switch (_context146.prev = _context146.next) {
            case 0:
              return _context146.abrupt("return", this._storageClient.getData(getLocalStorageKey(this._publicToken)).then(function (localData) {
                if (!localData) {
                  return null;
                }
                var parsedState;
                try {
                  ...
                  _this33._storageClient.clearData(getLocalStorageKey(_this33._publicToken));
                ...
                _this33.state = state;
                _this33.session_token = session_token;
                _this33.session_jwt = session_jwt;
                _this33.intermediate_session_token = intermediate_session_token;
                return {
                  state: state,
...
var ConsumerSubscriptionService = /*#__PURE__*/function (_SubscriptionService) {
  ...
  function ConsumerSubscriptionService() {
    ...
    _this35 = _callSuper(this, ConsumerSubscriptionService, arguments);
    _this35.updateSession = function (resp) {
    ...
    _this35.updateUser = function (user) {
      return _this35.updateState({
        user: user
      });
    };
    _this35.getUser = function () {
      var _a, _b;
      return (_b = (_a = _this35.getState()) === null || _a === void 0 ? void 0 : _a.user) !== null && _b !== void 0 ? _b : null;
    };
    _this35.getSession = function () {
      var _a, _b;
      return (_b = (_a = _this35.getState()) === null || _a === void 0 ? void 0 : _a.session) !== null && _b !== void 0 ? _b : null;
    };
    return _this35;
  }
...
var B2BSubscriptionService = /*#__PURE__*/function (_SubscriptionService2) {
  ...
  function B2BSubscriptionService() {
    ...
    _this36 = _callSuper(this, B2BSubscriptionService, arguments);
    _this36.updateSession = function (originalResp) {
      // This is a bit of a hack to get the type inference to work. In practice,
      // opaque tokens are only a concern on web.
      var resp = originalResp;
      if ('member_session' in resp && resp.member_session) {
        _this36.updateStateAndTokens({
          state: {
    ...
    _this36.updateMember = function (member) {
      return _this36.updateState({
        member: member
      });
    };
    _this36.getMember = function () {
      var _a, _b;
      return (_b = (_a = _this36.getState()) === null || _a === void 0 ? void 0 : _a.member) !== null && _b !== void 0 ? _b : null;
    };
    _this36.updateOrganization = function (organization) {
      return _this36.updateState({
        organization: organization
      });
    };
    _this36.getOrganization = function () {
      var _a, _b;
      return (_b = (_a = _this36.getState()) === null || _a === void 0 ? void 0 : _a.organization) !== null && _b !== void 0 ? _b : null;
    };
    _this36.getSession = function () {
      var _a, _b;
      return (_b = (_a = _this36.getState()) === null || _a === void 0 ? void 0 : _a.session) !== null && _b !== void 0 ? _b : null;
    };
    return _this36;
  }
