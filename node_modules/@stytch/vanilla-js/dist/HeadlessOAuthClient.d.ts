import { IHeadlessOAuthClient, StytchProjectConfigurationInput } from '@stytch/core/public';
...
export interface IWebOAuthClient<TProjectConfiguration extends StytchProjectConfigurationInput> extends IHeadlessOAuthClient<TProjectConfiguration> {
    googleOneTap: IGoogleOneTapOAuthProvider;
}
export declare class HeadlessOAuthClient<TProjectConfiguration extends StytchProjectConfigurationInput> extends BaseHeadlessOAuthClient<TProjectConfiguration> implements IWebOAuthClient<TProjectConfiguration> {
    private _oneTap;
    constructor(_networkClient: INetworkClient, _subscriptionService: IConsumerSubscriptionService<TProjectConfiguration>, _pkceManager: IPKCEManager, _dynamicConfig: DynamicConfig, _config: Config, _oneTap: OneTapProvider);
    private startOneTap;
    googleOneTap: IGoogleOneTapOAuthProvider;
}
export {};
