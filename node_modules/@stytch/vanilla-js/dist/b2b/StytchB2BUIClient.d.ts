...
import { Callbacks, StyleConfig, StytchB2BUIConfig, StytchProjectConfigurationInput } from '@stytch/core/public';
 ...
 * });
 */
export declare class StytchB2BUIClient<TProjectConfiguration extends StytchProjectConfigurationInput = Stytch.DefaultProjectConfiguration> extends StytchB2BHeadlessClient<TProjectConfiguration> {
