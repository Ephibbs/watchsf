...
import { IHeadlessB2BOAuthClient, StytchProjectConfigurationInput } from '@stytch/core/public';
import { HeadlessB2BOAuthClient as BaseHeadlessB2BOAuthClient, IDFPProtectedAuthProvider, INetworkClient, IPKCEManager, IB2BSubscriptionService } from '@stytch/core';
...
export interface IWebB2BOAuthClient<TProjectConfiguration extends StytchProjectConfigurationInput> extends IHeadlessB2BOAuthClient<TProjectConfiguration> {
    googleOneTap: IB2BGoogleOneTapOAuthProvider;
}
export declare class HeadlessB2BOAuthClient<TProjectConfiguration extends StytchProjectConfigurationInput> extends BaseHeadlessB2BOAuthClient<TProjectConfiguration> implements IWebB2BOAuthClient<TProjectConfiguration> {
    private _oneTap;
    constructor(_networkClient: INetworkClient, _subscriptionService: IB2BSubscriptionService<TProjectConfiguration>, _pkceManager: IPKCEManager, _dynamicConfig: DynamicConfig, _config: Config, _dfpProtectedAuth: IDFPProtectedAuthProvider | undefined, _oneTap: B2BOneTapProvider);
