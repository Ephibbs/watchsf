...
var extractErrorMessage = require('../extractErrorMessage-BCwCOwx4.js');
var internal = require('../internal-CVhHewZm.js');
...
var ErrorHeader = extractErrorMessage.He(Text)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  text-align: center;\n"])));
...
var Input = extractErrorMessage.He.input(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  background-color: ", ";\n  height: 47px;\n  padding: 0 8px;\n  box-sizing: border-box;\n  border: 1px solid ", ";\n  border-radius: ", ";\n  color: ", ";\n  font-family: ", ";\n  font-size: 18px;\n  &::placeholder {\n    color: ", ";\n  }\n\n  &:disabled {\n    border: 1px solid ", ";\n    color: ", ";\n    background-color: ", ";\n  }\n"])), function (props) {
...
var Button = extractErrorMessage.He.button(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  all: unset;\n  width: 100%;\n  height: 45px;\n  border-radius: 4px;\n  cursor: pointer;\n  font-size: 18px;\n  text-transform: none;\n  font-family: ", ";\n  box-shadow: none;\n  text-align: center;\n\n  ", "\n\n  &:disabled {\n    background-color: ", ";\n    color: ", ";\n    border: ", ";\n    border-radius: ", ";\n    cursor: not-allowed;\n  }\n"])), function (props) {
  return props.theme.typography.fontFamily;
}, function (props) {
...
var circularRotateKeyframe = extractErrorMessage.Ue(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  0% {\n    transform: rotate(0deg);\n  }\n  100% {\n    transform: rotate(360deg);\n  }\n"])));
var circularDashKeyframe = extractErrorMessage.Ue(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n  0% {\n    stroke-dasharray: 1px, 200px;\n    stroke-dashoffset: 0;\n  }\n  50% {\n    stroke-dasharray: 100px, 200px;\n    stroke-dashoffset: -15px;\n  }\n  100% {\n    stroke-dasharray: 100px, 200px;\n    stroke-dashoffset: -125px;\n  }\n"])));
var AnimatedCircle = extractErrorMessage.He.circle(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n  stroke-dasharray: 80px, 200px;\n  stroke-dashoffset: 0;\n  animation: ", " 1.4s ease-in-out infinite;\n  stroke: ", ";\n  fill: none;\n"])), circularDashKeyframe, function (props) {
  return props.theme.colors.primary;
});
var CircularProgressRoot = extractErrorMessage.He.div(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  width: ", "px;\n  height: ", "px;\n  animation: ", " 1.4s ease-in-out infinite;\n"])), function (props) {
  return props.size;
}, function (props) {
  return props.size;
}, circularRotateKeyframe);
var CircularProgressSVG = extractErrorMessage.He.svg(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  display: block;\n"])));
...
var StyledButton$1 = extractErrorMessage.He(Button)(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  height: auto;\n  min-height: 45px;\n"])));
...
var BackButton = extractErrorMessage.He.button(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  all: unset;\n  cursor: pointer;\n"])));
...
var GetHelpText = extractErrorMessage.He(Text)(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  font-weight: bold !important;\n  cursor: pointer;\n"])));
      ...
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          ...
          case 9:
            setErrorMessage('');
            setIsSubmitting(true);
            internal.readB2BInternals(stytch).searchManager.searchMember(email, organization.organization_id).then(function (_ref57) {
...
extractErrorMessage.He.div(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n  height: ", ";\n  display: ", ";\n  transition: all 0.5s ease-out;\n  justify-content: center;\n  align-items: center;\n"])), function (props) {
...
var UsePasswordText = extractErrorMessage.He(Text)(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  font-weight: bold !important;\n  cursor: pointer;\n"])));
...
var useEmailDomain = function useEmailDomain() {
  ...
  extractErrorMessage.p(function () {
    internal.readB2BInternals(stytch).bootstrap.getAsync().then(function (_ref99) {
...
var ye = function ye(e) {
  ...
  F = extractErrorMessage.w(function (_ref107) {
    var e = _ref107.toast,
      t = _ref107.position,
      o = _ref107.style,
      s = _ref107.children;
      ...
      return _regeneratorRuntime().wrap(function _callee7$(_context7) {
        while (1) switch (_context7.prev = _context7.next) {
          ...
          case 4:
            ...
            setIsSubmitting(true);
            if (organization) {
              internal.readB2BInternals(stytch).searchManager.searchMember(email, organization.organization_id).then(function (_ref110) {
...
var CountrySelector = function CountrySelector(_ref112) {
  ...
  }, Object.entries(internal.COUNTRIES_LIST).map(function (_ref113) {
                ...
                return _regeneratorRuntime().wrap(function _callee18$(_context18) {
                  while (1) switch (_context18.prev = _context18.next) {
                    ...
                    case 9:
                      ...
                      setError((_a = extractErrorMessage.extractErrorMessage(_context18.t0)) !== null && _a !== void 0 ? _a : null);
                    case 12:
                    case "end":
...
var SSODiscoveryFallback = function SSODiscoveryFallback() {
  ...
  var _extractErrorMessage$73 = extractErrorMessage.h(''),
    ...
    slug = _extractErrorMessage$74[0],
    setSlug = _extractErrorMessage$74[1];
  var _extractErrorMessage$75 = extractErrorMessage.h(null),
    _extractErrorMessage$76 = _slicedToArray(_extractErrorMessage$75, 2),
    error = _extractErrorMessage$76[0],
    setError = _extractErrorMessage$76[1];
  var _extractErrorMessage$77 = extractErrorMessage.h(false),
    _extractErrorMessage$78 = _slicedToArray(_extractErrorMessage$77, 2),
    isSubmitting = _extractErrorMessage$78[0],
    setIsSubmitting = _extractErrorMessage$78[1];
  var stytchClient = useStytch();
...
var useIDPState = function useIDPState(_ref145) {
  ...
  var _extractErrorMessage$79 = extractErrorMessage.h(parseOAuthAuthorizeParams(window.location.search)),
    _extractErrorMessage$80 = _slicedToArray(_extractErrorMessage$79, 1),
    parseResult = _extractErrorMessage$80[0];
  var _extractErrorMessage$81 = extractErrorMessage.s(idpStateReducer, initialState(parseResult)),
  ...
  extractErrorMessage.p(function () {
    ...
    onErrorRef.current(new internal.IDPOAuthFlowMissingParamError(errorMessage));
  }, [parseResult.error]);
...
var IDPConsentScreen = function IDPConsentScreen() {
  return /*#__PURE__*/extractErrorMessage.wn.createElement(EnsureMemberIsLoggedIn, null, /*#__PURE__*/extractErrorMessage.wn.createElement(IDPConsentScreenImpl, null));
};
...
var AppContainer$1 = function AppContainer$1() {
  ...
  var stytchClient = useStytch();
  var config = useConfig();
  var _extractErrorMessage$83 = extractErrorMessage.Ze(),
    displayWatermark = _extractErrorMessage$83.displayWatermark;
  var isOnlyFloatingOneTap = useIsOnlyFloatingOneTap();
...
var AppContainer = function AppContainer(_ref166) {
  ...
  var _extractErrorMessage$84 = extractErrorMessage.h(function () {
    ...
    displayWatermark = _extractErrorMessage$85[0],
    setDisplayWatermark = _extractErrorMessage$85[1];
  extractErrorMessage.p(function () {
    ...
    internal.readB2BInternals(client).bootstrap.getAsync().then(function (_ref167) {
