...
var ErrorHeader = He(Text)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  text-align: center;\n"])));
...
var Input = He.input(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  background-color: ", ";\n  height: 47px;\n  padding: 0 8px;\n  box-sizing: border-box;\n  border: 1px solid ", ";\n  border-radius: ", ";\n  color: ", ";\n  font-family: ", ";\n  font-size: 18px;\n  &::placeholder {\n    color: ", ";\n  }\n\n  &:disabled {\n    border: 1px solid ", ";\n    color: ", ";\n    background-color: ", ";\n  }\n"])), function (props) {
...
var Button = He.button(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  all: unset;\n  width: 100%;\n  height: 45px;\n  border-radius: 4px;\n  cursor: pointer;\n  font-size: 18px;\n  text-transform: none;\n  font-family: ", ";\n  box-shadow: none;\n  text-align: center;\n\n  ", "\n\n  &:disabled {\n    background-color: ", ";\n    color: ", ";\n    border: ", ";\n    border-radius: ", ";\n    cursor: not-allowed;\n  }\n"])), function (props) {
  return props.theme.typography.fontFamily;
}, function (props) {
...
var circularRotateKeyframe = Ue(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  0% {\n    transform: rotate(0deg);\n  }\n  100% {\n    transform: rotate(360deg);\n  }\n"])));
var circularDashKeyframe = Ue(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n  0% {\n    stroke-dasharray: 1px, 200px;\n    stroke-dashoffset: 0;\n  }\n  50% {\n    stroke-dasharray: 100px, 200px;\n    stroke-dashoffset: -15px;\n  }\n  100% {\n    stroke-dasharray: 100px, 200px;\n    stroke-dashoffset: -125px;\n  }\n"])));
var AnimatedCircle = He.circle(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n  stroke-dasharray: 80px, 200px;\n  stroke-dashoffset: 0;\n  animation: ", " 1.4s ease-in-out infinite;\n  stroke: ", ";\n  fill: none;\n"])), circularDashKeyframe, function (props) {
  return props.theme.colors.primary;
});
var CircularProgressRoot = He.div(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  width: ", "px;\n  height: ", "px;\n  animation: ", " 1.4s ease-in-out infinite;\n"])), function (props) {
  return props.size;
}, function (props) {
  return props.size;
}, circularRotateKeyframe);
var CircularProgressSVG = He.svg(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  display: block;\n"])));
...
var useEmailOtpLoginOrSignup = function useEmailOtpLoginOrSignup() {
  ...
  var stytchClient = useStytch();
  var config = useConfig();
  return useMutate('stytch.otps.email.loginOrSignup', function (_key, _ref45) {
    var _ref45$arg = _ref45.arg,
      email = _ref45$arg.email,
      organization_id = _ref45$arg.organization_id;
    var _a, _b;
...
var useEmlDiscoverySend = function useEmlDiscoverySend() {
  ...
  var stytchClient = useStytch();
  var config = useConfig();
  return useMutate('stytch.magicLinks.email.discovery.send', function (_, _ref46) {
...
var useEmlLoginOrSignup = function useEmlLoginOrSignup() {
  ...
  var stytchClient = useStytch();
  var config = useConfig();
  return useMutate('stytch.magicLinks.email.loginOrSignup', function (_, _ref47) {
...
var parseErrorMessage = function parseErrorMessage(error, _ref48) {
  var email = _ref48.email,
    org = _ref48.org;
...
var StyledButton$1 = He(Button)(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  height: auto;\n  min-height: 45px;\n"])));
var OutlinedButton = function OutlinedButton(_ref49) {
  var onClick = _ref49.onClick,
    id = _ref49.id,
...
var IdentityProviderIcon = function IdentityProviderIcon(_ref50) {
  var identityProvider = _ref50.identityProvider;
  var _a;
  var Icon = (_a = iconMap[identityProvider]) !== null && _a !== void 0 ? _a : SSOIcon;
  return /*#__PURE__*/y(Icon, null);
};
var SSOButton = function SSOButton(_ref51) {
  var display_name = _ref51.display_name,
    connection_id = _ref51.connection_id,
    identity_provider = _ref51.identity_provider;
  var stytchClient = useStytch();
  var config = useConfig();
...
var PasswordIconSvg = function PasswordIconSvg(_ref52) {
  var _ref52$enabled = _ref52.enabled,
    enabled = _ref52$enabled === void 0 ? false : _ref52$enabled;
  return /*#__PURE__*/wn.createElement("svg", {
    width: "20",
    height: "14",
    viewBox: "0 0 20 14",
...
var PasswordIcon = function PasswordIcon(_ref53) {
  var onClick = _ref53.onClick,
    enabled = _ref53.enabled,
    visible = _ref53.visible;
...
var PasswordInput = function PasswordInput(_ref54) {
  var password = _ref54.password,
    setPassword = _ref54.setPassword,
    type = _ref54.type;
  var _h$17 = h$2(false),
...
var BackButton = He.button(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  all: unset;\n  cursor: pointer;\n"])));
var BackArrowSvg = function BackArrowSvg(_ref55) {
...
var BackArrow = function BackArrow(_ref56) {
...
var GetHelpText = He(Text)(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  font-weight: bold !important;\n  cursor: pointer;\n"])));
      ...
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          ...
          case 9:
            setErrorMessage('');
            setIsSubmitting(true);
            readB2BInternals(stytch).searchManager.searchMember(email, organization.organization_id).then(function (_ref57) {
              var member = _ref57.member;
...
var OAuthErrorMessage = function OAuthErrorMessage(_ref58) {
...
var RedirectUrlsErrorMessage = function RedirectUrlsErrorMessage(_ref59) {
  var niceName = _ref59.niceName,
    variableName = _ref59.variableName;
...
He.div(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n  height: ", ";\n  display: ", ";\n  transition: all 0.5s ease-out;\n  justify-content: center;\n  align-items: center;\n"])), function (props) {
  return "".concat(props.$height, "px");
}, function (props) {
  return props.pending ? 'flex' : 'block';
});
var B2BGoogleOneTap = function B2BGoogleOneTap(_ref60) {
  var customScopes = _ref60.customScopes,
    providerParams = _ref60.providerParams;
...
var UsePasswordText = He(Text)(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  font-weight: bold !important;\n  cursor: pointer;\n"])));
...
var generateProductComponentsOrdering = function generateProductComponentsOrdering(products, flowState) {
  ...
  var productComponents = Array.from(productComponentsSet).reduce(function (groups, component, i, arr) {
...
var ArrowText = He.div(_templateObject29 || (_templateObject29 = _taggedTemplateLiteral(["\n  ", ";\n  text-align: right;\n"])), function (_ref73) {
  var theme = _ref73.theme;
  return theme.typography.body;
});
var SvgNoShrink = He.svg(_templateObject30 || (_templateObject30 = _taggedTemplateLiteral(["\n  flex-shrink: 0;\n"])));
...
var ActionText = function ActionText(_ref75) {
...
var Discovery = function Discovery() {
  ...
  var _useMutate3 = useMutate("stytch.discovery.intermediateSessions.exchange", function (_, _ref76) {
      var organizationId = _ref76.arg.organizationId;
...
var StyledButton = He.button(_templateObject31 || (_templateObject31 = _taggedTemplateLiteral(["\n  all: unset;\n  color: ", ";\n  cursor: pointer;\n  padding: 20px 0;\n  border-bottom: 1px solid #e5e8eb;\n  font-weight: 500;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n"])), function (props) {
  return props.theme.colors.primary;
});
...
var Form = He.form(_templateObject42 || (_templateObject42 = _taggedTemplateLiteral(["\n  width: 100%;\n"])));
  ...
  var resendResetPassword = function resendResetPassword() {
    ...
    if (!organization) {
      ...
      stytch.passwords.resetByEmailStart({
        email_address: email,
        organization_id: organization.organization_id,
        login_redirect_url: (_e = config.passwordOptions) === null || _e === void 0 ? void 0 : _e.loginRedirectURL,
...
var InsetContainer = He.div(_templateObject59 || (_templateObject59 = _taggedTemplateLiteral(["\n  background-color: #f3f5f6;\n  color: #000;\n  font-size: 16px;\n  line-height: 28px;\n  display: flex;\n  align-items: flex-start;\n  justify-content: center;\n  gap: 8px;\n  padding: 16px 8px;\n"])));
var CodeList = He.ul(_templateObject60 || (_templateObject60 = _taggedTemplateLiteral(["\n  list-style: none;\n  padding: 0;\n  margin: 0;\n"])));
...
var Select = He.select(_templateObject61 || (_templateObject61 = _taggedTemplateLiteral(["\n  background-color: ", ";\n  border: 1px solid ", ";\n  border-radius: ", ";\n  height: 47px;\n  box-sizing: border-box;\n  padding: 0 8px;\n  color: ", ";\n  font-family: ", ";\n  width: 80px;\n  font-size: 18px;\n"])), function (props) {
  return props.theme.inputs.backgroundColor;
}, function (props) {
  return props.theme.inputs.borderColor;
}, function (props) {
...
var ssoDiscoveryConnection = function ssoDiscoveryConnection(networkClient, emailAddress) {
  return __awaiter(void 0, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee16() {
    return _regeneratorRuntime().wrap(function _callee16$(_context16) {
      while (1) switch (_context16.prev = _context16.next) {
        case 0:
          _context16.next = 2;
          return networkClient.fetchSDK({
            method: 'GET',
    ...
    return __awaiter(void 0, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee17() {
      return _regeneratorRuntime().wrap(function _callee17$(_context17) {
        while (1) switch (_context17.prev = _context17.next) {
          case 0:
            _context17.next = 2;
            return ssoDiscoveryConnection(networkClient, emailAddress);
          case 2:
...
var SSODiscoveryEmail = function SSODiscoveryEmail() {
  ...
  var _useSsoDiscoveryConne = useSsoDiscoveryConnection(),
    ...
    isMutating = _useSsoDiscoveryConne.isMutating;
  var stytch = useStytch();
                ...
                return _regeneratorRuntime().wrap(function _callee18$(_context18) {
                  while (1) switch (_context18.prev = _context18.next) {
                    ...
                    case 9:
                      ...
                      setError((_a = extractErrorMessage(_context18.t0)) !== null && _a !== void 0 ? _a : null);
                    case 12:
                    case "end":
...
var SSODiscoveryFallback = function SSODiscoveryFallback() {
  ...
  var _h$67 = h$2(false),
    ...
    isSubmitting = _h$68[0],
    setIsSubmitting = _h$68[1];
  var stytchClient = useStytch();
...
var CopyButton = He.button(_templateObject63 || (_templateObject63 = _taggedTemplateLiteral(["\n  all: unset;\n  flex: 0 0 24px;\n  height: 28px;\n  opacity: 0;\n  :focus {\n    opacity: 1;\n  }\n"])));
var CodeContainer = He(InsetContainer)(_templateObject64 || (_templateObject64 = _taggedTemplateLiteral(["\n  cursor: pointer;\n  :hover ", " {\n    opacity: 1;\n  }\n"])), CopyButton);
var Spacer = He.div(_templateObject65 || (_templateObject65 = _taggedTemplateLiteral(["\n  flex: 0 1 24px;\n"])));
var Code = He.code(_templateObject66 || (_templateObject66 = _taggedTemplateLiteral(["\n  white-space: pre-wrap;\n  align-self: center;\n  text-align: center;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  flex-wrap: wrap;\n  gap: 1ch;\n"])));
...
var QRCodeImg = He.img(_templateObject67 || (_templateObject67 = _taggedTemplateLiteral(["\n  margin: 0 auto;\n"])));
      ...
      return _regeneratorRuntime().wrap(function _callee25$(_context25) {
        while (1) switch (_context25.prev = _context25.next) {
          ...
          case 8:
            ...
            message = _context25.t0.error_message;
            dispatch({
              type: 'PREFLIGHT_ERROR',
              error: message
            });
            onErrorRef.current(_context25.t0);
...
var IDPConsent = function IDPConsent(_ref148) {
  var bootstrap = _ref148.bootstrap,
    bootstrapNotLoaded = _ref148.bootstrapNotLoaded,
    children = _ref148.children,
    state = _ref148.state,
    submit = _ref148.submit;
...
var Consent = function Consent(_ref149) {
  var client = _ref149.client,
    submit = _ref149.submit,
    grantableScope = _ref149.grantableScope,
    projectName = _ref149.projectName,
    children = _ref149.children;
...
var ConsentManifestGeneratorProvider = function ConsentManifestGeneratorProvider(_ref150) {
  var children = _ref150.children,
    consentManifestGenerator = _ref150.consentManifestGenerator;
...
var ScopeList = He.ul(_templateObject73 || (_templateObject73 = _taggedTemplateLiteral(["\n  padding: 0;\n"])));
var ScopeListItem = He.li(_templateObject74 || (_templateObject74 = _taggedTemplateLiteral(["\n  padding: 4px;\n  box-sizing: border-box;\n  position: relative;\n  list-style: none;\n\n  &:not(:last-child) {\n    border-bottom: 1px solid ", ";\n  }\n"])), function (_ref151) {
  var theme = _ref151.theme;
  return theme.colors.secondary;
});
var ItemSummary = He.summary(_templateObject75 || (_templateObject75 = _taggedTemplateLiteral(["\n  list-style: none;\n  display: flex;\n  justify-content: space-between;\n  cursor: ", ";\n"])), function (props) {
  return props.expandable ? 'pointer' : 'default';
});
var DropdownArrowSvg = He.svg(_templateObject76 || (_templateObject76 = _taggedTemplateLiteral(["\n  width: 32px;\n  height: 32px;\n  margin-left: 10px;\n  margin-top: -5px;\n  vertical-align: top;\n  flex-shrink: 0;\n  transition: transform 0.3s ease;\n  details[open] & {\n    transform: rotate(90deg);\n  }\n"])));
var ItemNestedDetailsList = He.ul(_templateObject77 || (_templateObject77 = _taggedTemplateLiteral(["\n  padding: 4px 24px;\n  list-style: none;\n"])));
...
var Item = function Item(_ref152) {
  var item = _ref152.item;
  var _a, _b, _c, _d;
...
var SectionHeader = He(Text)(_templateObject78 || (_templateObject78 = _taggedTemplateLiteral(["\n  font-weight: 600;\n"])));
var Section = function Section(_ref153) {
  var section = _ref153.section;
...
var ConsentManifest = function ConsentManifest(_ref154) {
  var manifest = _ref154.manifest,
    clientName = _ref154.clientName;
...
var UngrantableSection = He.details(_templateObject79 || (_templateObject79 = _taggedTemplateLiteral(["\n  border: ", ";\n  border-radius: ", ";\n  padding: 16px;\n  margin-bottom: 36px;\n"])), function (_ref155) {
...
var UngrantableSummary = He.summary(_templateObject80 || (_templateObject80 = _taggedTemplateLiteral(["\n  list-style: none;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  cursor: pointer;\n\n  details[open] > & {\n    padding-bottom: 8px;\n    margin-bottom: 8px;\n    border-bottom: 1px solid ", ";\n  }\n"])), function (_ref157) {
  var theme = _ref157.theme;
  return theme.colors.secondary;
});
var UngrantableNestedDetailsList = He.ul(_templateObject81 || (_templateObject81 = _taggedTemplateLiteral(["\n  padding: 4px;\n  margin: 0;\n  list-style: none;\n"])));
var UngrantableScopes = function UngrantableScopes(_ref158) {
  var clientName = _ref158.clientName,
    ungrantableScopeDescriptions = _ref158.ungrantableScopeDescriptions;
...
var AppContainer = function AppContainer(_ref166) {
  ...
  var _h$71 = h$2(function () {
    ...
    displayWatermark = _h$72[0],
    setDisplayWatermark = _h$72[1];
  p$1(function () {
