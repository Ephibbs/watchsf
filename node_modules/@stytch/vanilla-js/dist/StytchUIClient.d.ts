...
import { Callbacks, StytchLoginConfig, StyleConfig, StytchProjectConfigurationInput } from '@stytch/core/public';
/**
 ...
 * });
 */
export declare class StytchUIClient<TProjectConfiguration extends StytchProjectConfigurationInput = Stytch.DefaultProjectConfiguration> extends StytchHeadlessClient<TProjectConfiguration> {
