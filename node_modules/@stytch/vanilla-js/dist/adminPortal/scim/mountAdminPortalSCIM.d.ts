 ...
 */
export declare const mountAdminPortalSCIM: (options: import("./AdminPortalSCIM").AdminPortalSCIMMountOptions<Partial<import("@stytch/core/dist/public").StytchProjectConfiguration>>) => void;
