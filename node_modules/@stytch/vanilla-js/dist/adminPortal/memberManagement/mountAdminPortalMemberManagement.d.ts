 ...
 */
export declare const mountAdminPortalMemberManagement: (options: import("./AdminPortalMemberManagement").AdminPortalMemberManagementMountOptions<Partial<import("@stytch/core/dist/public").StytchProjectConfiguration>>) => void;
