 ...
 */
export declare const mountAdminPortalOrgSettings: (options: import("./AdminPortalOrgSettings").AdminPortalOrgSettingsMountOptions<Partial<import("@stytch/core/dist/public").StytchProjectConfiguration>>) => void;
