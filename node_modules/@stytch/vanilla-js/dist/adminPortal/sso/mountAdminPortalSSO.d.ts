 ...
 */
export declare const mountAdminPortalSSO: (options: import("./AdminPortalSSO").AdminPortalSSOMountOptions<Partial<import("@stytch/core/dist/public").StytchProjectConfiguration>>) => void;
