 ...
 */
export declare function CreateSSRSafeWebComponent<P extends React.JSX.IntrinsicAttributes & object>(ReactComponent: React.ComponentType<P>, webComponentName: string): <TProjectConfiguration extends Partial<import("@stytch/core/public").StytchProjectConfiguration>>(props: P) => IReactWebComponent<P>;
export {};
